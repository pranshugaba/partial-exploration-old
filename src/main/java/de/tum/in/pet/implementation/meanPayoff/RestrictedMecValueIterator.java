...
public class RestrictedMecValueIterator<M extends Model> {
  ...
  public final RewardGenerator rewardGenerator;

  public RestrictedMecValueIterator(RestrictedModel<M> restrictedModel, double targetPrecision, RewardGenerator rewardGenerator){
