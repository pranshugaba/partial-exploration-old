...
class InputValues:
    def __init__(self, information_level, update_method, simulate_mec, get_error_probability):
...
def parse_user_input():
    ...
    return InputValues(info_level, update_method, simulate_mec, get_error_probability)
